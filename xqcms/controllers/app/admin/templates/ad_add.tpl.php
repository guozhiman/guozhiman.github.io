...
<td class="f_gray"><input type="text" size="60" name="ad[image_src]" id="thumb"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,<?php echo $p['width'];?>,<?php echo $p['height'];?>, $('#thumb').val());" class="jt">上传</span>&nbsp;&nbsp;<span onclick="_preview($('#thumb').val());" class="jt">预览</span>&nbsp;&nbsp;<span onclick="$('#thumb').val('');" class="jt">删除</span> <span id="dthumb" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">链接地址</td>
...
<td class="f_gray"><input type="text" size="60" name="ad[flash_src]" id="flash"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, $('#flash').val(), 'flash');" class="jt">上传</span>&nbsp;&nbsp;<span onclick="if($('#flash').val()) window.open($('#flash').val());" class="jt">预览</span>&nbsp;&nbsp;<span onclick="$('#flash').val('');" class="jt">删除</span> <span id="dflash" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">链接地址</td>
...
<td class="tl">广告状态</td>
<td>
<input type="radio" name="ad[status]" value="3" checked/> 通过
<input type="radio" name="ad[status]" value="2"/> 审核
</td>
</tr>
</table>
</td>
