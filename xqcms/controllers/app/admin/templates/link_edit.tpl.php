...
<table class="tb">
<thead>
<th colspan="2"><?php echo $action == 'add' ? '添加' : '修改';?>链接</th>
</thead>
<tr>
<td class="tdbr">
<table class="c_tb">
...
<td><?php echo type_select('link', 1, 'post[tid]', '请选择分类', $tid, 'id="tid"');?> <span id="dtid" class="f_red"></span></td>
</tr>
<tr>
...
<td><input name="post[thumb]" type="text" id="thumb" size="40" value="<?php echo $thumb;?>"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,88,31, $('#thumb').val());" class="jt">上传</span>&nbsp;&nbsp;<span onclick="_preview($('#thumb').val());" class="jt">预览</span>&nbsp;&nbsp;<span onclick="$('#thumb').val('');" class="jt">删除</span></td>
</tr>
<tr>
<td class="tl">网站介绍</td>
