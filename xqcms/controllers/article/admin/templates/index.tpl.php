...
<table class="tb">
<thead>
<th colspan="8"><?php echo $menus[$menuid][0];?></th>
</thead>
<tbody>
<tr>
...
<td align="left">&nbsp;<a href="<?php echo $v['url'];?>" target="_blank"><?php echo $v['title'];?></a><?php if($v['thumb']) {?> <a href="javascript:_preview('<?php echo $v['thumb'];?>');"><img src="data/style/img.gif" width="10" height="10" title="标题图,点击预览" alt=""/></a><?php } ?> &nbsp;<?php if($v['posid']) echo '<font class="f_orange px11">'.posid_select_s($v['posid']).'</font>';?></td>
<td>
<?php echo $v['username'];?>
</td>
